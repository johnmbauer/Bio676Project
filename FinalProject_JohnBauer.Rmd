...
### Figure 2:Uprooted maximum-likelyhood phylogentic tree of gammaproteobactria
...
### Figure 3: Toolik Field Station, Alaska USA
...
### Figure 4: Phylogenetic treee of all MAGs collected in GOLD Study ID Gs0161344 by the National Ecological Observatory Network with the *Gammaproteobacteria* class of Psedomondata highlighted in blue
```{r, , fig.height=14, fig.width=12, fig.align='center'}
...
```
**Figure 4:** Phylogenetic tree of all bacterial MAGs collected in GOLD Study ID Gs0161344 by the National Ecological Observatory Network with the *Gammaproteobacteria* class of *Psedomondata* highlighted in blue
...
```
**Figure 6:** Overall NEON Site Distribution of MAGs organized by phylum.
...
### Figure 2: Sankey plot of Individual Assemebly *Gammmaproteobacteria* MAGs
```{r,fig.height=20, fig.width=8,fig.align='center'}
knitr::include_url("data/lab14/sankey-NEON_MAG_ind_Gpro.txt.html")
```
**Figure 2:** Sankey plot of individual assembly *Gammmaproteobacteria* MAGs
...
```
**Figure 10:** Phylogenetic Tree of *Gammaproteobacteria* with Ecosystem Subtype and Number of Bases markers.This tree includes MAG reads from all NEON sites filtered to those annotated as belonging to the class Gammaproteobacteria.
