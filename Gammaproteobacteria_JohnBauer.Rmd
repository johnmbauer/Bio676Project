...
ggsave(
  "Gammaproteobacteria_distribution_by_order.png",
  plot = last_plot(),
  device = NULL,
...
ggsave(
  "Gammaproteobacteria_Gene_Count_vs_Estimated_Mag_Genome_Size_with_Order.png",
  plot = last_plot(),
  device = NULL,
  path = "/cloud/project/images/Plots/Gamma",
  scale = 1,
...
```{r, fig.height=12, fig.width=12}
ggtree(tree_Gammaproteobacteria, layout="circular")+geom_point2(aes(subset=(node==1444)), shape=23, size=5, fill='steelblue')
